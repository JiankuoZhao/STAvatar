...
class  ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.sh_degree = 3
        self._source_path = "/path/to/input/dataset"  # Path to the source data set
        self._target_path = ""  # Path to the target data set for pose and expression transfer
        self._model_path = "/path/to/save/models"  # Path to the folder to save trained models
        self._images = "images"
        self._resolution = -1
