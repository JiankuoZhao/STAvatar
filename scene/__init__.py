...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : Union[GaussianModel, FlameGaussianModel], load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):  #* constrcut from sparse points
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval)
        elif os.path.exists(os.path.join(args.source_path, "canonical_flame_param.npz")):  #* construct from flame mesh
        ...
        elif os.path.exists(os.path.join(args.source_path, "transforms_train.json")):  #* construct from blender
