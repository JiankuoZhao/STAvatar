...
def render(
    ...
    # create screenspace_points for all Gaussians
    screenspace_points = torch.zeros(N, 3, dtype=pc.get_xyz.dtype, requires_grad=True, device="cuda")
    ...
    return {
        ...
        "radii": radii,
        "pixels_per_gs": pixels_per_gs,
        "accum_alpha_per_gs": accum_alpha_per_gs,
        "gs_per_pixels": gs_per_pixels,
